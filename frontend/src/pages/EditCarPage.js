...
function EditCarPage() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        if ( !description || !price || !stock || !images.length) {
            return alert("Please fill out all the fields");
        }
        updateProduct({ id, description, price, stock, images }).then(({ data }) => {
            if (data.length > 0) {
                setTimeout(() => {
                    navigate("/");
                }, 1500);
        ...
        >
                    <Form style={{ width: "100%" }} onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control as="textarea" placeholder="Product description" style={{ height: "100px" }} value={description} onChange={(e) => setDescription(e.target.value)} />
                        </Form.Group>
                        ...
                        {/* <Form.Group className="mb-3" onChange={(e) => setStock(e.target.value)}>
