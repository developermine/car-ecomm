...
export const userSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addMatcher(appApi.endpoints.addToWishlist.matchFulfilled, (_, { payload }) => payload);
        builder.addMatcher(appApi.endpoints.removeFromWishlist.matchFulfilled, (_, { payload }) => payload);
